...
class ListSourceAdapter(private val context: Context, private val website: WebSite) :
    ...
    override fun onCreateViewHolder(container: ViewGroup, position: Int): ListSourceViewHolder {
        val inflater = LayoutInflater.from(context)
        val itemView = inflater.inflate(R.layout.source_news_layout, container, false)
